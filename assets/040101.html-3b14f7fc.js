...
<span class="token keyword">if</span> <span class="token punctuation">(</span>module<span class="token punctuation">.</span>hot<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当引用 css 的时候只需要引用，并不需要上面这一坨代码，就是因为 <code>css-loader</code> 已经内置了上面的方法，就像在写 vue、react 代码不需要写上面这坨代码一样，他们的 loader 中也内置了这些方法。只有在使用一些特殊的文件类型才需要。（react 是借助 babel-preset 实现的）</p><blockquote><p>业务开发时，一般不是设置 hotOnly，这样才能实时显示最新代码和更改效果</p></blockquote><h2 id="babel" tabindex="-1"><a class="header-anchor" href="#babel" aria-hidden="true">#</a> Babel</h2><h3 id="安装-1" tabindex="-1"><a class="header-anchor" href="#安装-1" aria-hidden="true">#</a> 安装</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># babel-loader将 webpack 与 babel 建立关联</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果引入的一些 <code>css</code> 或依赖不需要 <code>Tree Shaking</code>，那将 <code>sideEffects</code> 设置为 <code>[&quot;./a.css&quot;, &quot;@babel/polyfill&quot;]</code>，如果没有需要配置的，直接设置为 <code>false</code> 即可。</p><h3 id="production" tabindex="-1"><a class="header-anchor" href="#production" aria-hidden="true">#</a> production</h3><p>线上环境是不需要配置 <code>usedExports</code> 的，但是还是需要配置 <code>package.json</code>。</p>`,101),m={href:"https://zhuanlan.zhihu.com/p/40052192",target:"_blank",rel:"noopener noreferrer"},b={href:"https://zhuanlan.zhihu.com/p/32831172",target:"_blank",rel:"noopener noreferrer"},g=a(`<h2 id="配置文件整理" tabindex="-1"><a class="header-anchor" href="#配置文件整理" aria-hidden="true">#</a> 配置文件整理</h2><p>比如在 <code>Vue</code> 官方的脚手架中 <code>webpack</code> 的配置文件都放在 <code>build</code> 文件夹中，如果我们希望对配置文件进行整理的话，需要做一下处理：</p><ol><li><p>将开发环境和线上环境的公共配置提取到 <code>/build/webpack.base.js</code> 中</p></li><li><p>分别在开发环境和线上环境的配置中合并公共配置，配置合并需要使用 <code>webpack-merge</code></p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// /build/webpack.dev.js</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>VSCode 安装 ESLint 插件，实时显示错误。</p></blockquote>`,93),f=n("code",null,"Eslint parsing error: Unexpected token <",-1),x={href:"https://github.com/BenoitZugmeyer/eslint-plugin-html",target:"_blank",rel:"noopener noreferrer"},w=n("div",{class:"custom-container tip"},[n("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},[n("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[n("circle",{cx:"12",cy:"12",r:"9"}),n("path",{d:"M12 8h.01"}),n("path",{d:"M11 12h1v4h1"})])]),n("p",{class:"custom-container-title"},"TIP"),n("p",null,[s("实际项目中为了不影响打包速度，可以不配置 "),n("code",null,"eslint-loader"),s("，而是直接通过 git 钩子，在提交命令代码时进行检测，当然这个时候就放弃了实时报错的特性。")]),n("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"git"),s(` 钩子 eslint src
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])])],-1),j=a(`<h2 id="提升打包速度" tabindex="-1"><a class="header-anchor" href="#提升打包速度" aria-hidden="true">#</a> 提升打包速度</h2><ol><li>跟上技术的迭代，保持最新（Node/Npm/Yarn）</li><li>在尽快少的模块上使用 <code>loader</code>，比如通过 <code>include</code> 和 <code>exclude</code> 来指定打包监听范围<div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">rules</span><span class="token operator">:</span> <span class="token punctuation">[</span>
      <span class="token punctuation">{</span>
        <span class="token literal-property property">test</span><span class="token operator">:</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">\\.js$</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="用-terser-webpack-plugin-替换掉-uglifyjs-webpack-plugin-解决-uglifyjs-不支持-es6-语法问题" tabindex="-1"><a class="header-anchor" href="#用-terser-webpack-plugin-替换掉-uglifyjs-webpack-plugin-解决-uglifyjs-不支持-es6-语法问题" aria-hidden="true">#</a> 用 terser-webpack-plugin 替换掉 uglifyjs-webpack-plugin 解决 uglifyjs 不支持 es6 语法问题</h3>`,47);function q(_,C){const e=o("ExternalLinkIcon");return c(),l("div",null,[u,i(" more "),d,k,v,n("ul",null,[n("li",null,[n("a",m,[s("Webpack 中的 sideEffects 到底该怎么用？"),p(e)])]),n("li",null,[n("a",b,[s("你的Tree-Shaking并没什么卵用"),p(e)])])]),g,n("ul",null,[n("li",null,[n("a",y,[s("webpack4之splitchunksPlugin拆拆拆--项目实践"),p(e)])])]),h,n("p",null,[s("如果报错 "),f,s("，可以借助 "),n("a",x,[s("eslint-plugin-html"),p(e)]),s("来解决。")]),w,j])}const E=t(r,[["render",q],["__file","040101.html.vue"]]);export{E as default};
